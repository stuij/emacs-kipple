...
(defcustom swbuff-exclude-buffer-regexps '("\\(^ .+$\\|\\*Messages\\*\\|*Compile-Log\\*\\|*slime-events\\*\\)")
...
and `swbuff-switch-to-previous-buffer' commands."
  (global-set-key [(f3)]       'swbuff-switch-to-next-buffer)
  (global-set-key [(f2)] 'swbuff-switch-to-previous-buffer))
